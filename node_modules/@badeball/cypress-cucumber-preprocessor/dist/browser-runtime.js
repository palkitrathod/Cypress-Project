...
function afterEachHandler(context) {
    ...
    if (remainingSteps.length > 0) {
        if (((_a = this.currentTest) === null || _a === void 0 ? void 0 : _a.state) === "failed") {
            const error = (0, assertions_1.assertAndReturn)((_b = this.currentTest) === null || _b === void 0 ? void 0 : _b.err, "Expected to find an error");
            const message = (0, assertions_1.assertAndReturn)(error.message, "Expected to find an error message");
            ...
            const hookIdOrPickleStepId = (0, assertions_1.assertAndReturn)((_d = (_c = failedStep.hook) === null || _c === void 0 ? void 0 : _c.id) !== null && _d !== void 0 ? _d : (_e = failedStep.pickleStep) === null || _e === void 0 ? void 0 : _e.id, "Expected a step to either be a hook or a pickleStep");
            const testStepId = getTestStepId({
                context,
                pickleId: pickle.id,
                hookIdOrPickleStepId,
